<html>
    ...
    <body>
        ...
        <div class="left"></div>
        <div class="middle">
            <form action="user_signup_query.php">
            <table border="5" style="text-align:center;">
                <tr><td><input type="text" placeholder="NAME" name="t1"></td></tr>
                <tr><td><input type="text" placeholder="MOBILE" name="t2"></td></tr>
                <tr><td><input type="password" placeholder="PASSWORD" name="t3"></td></tr>
