<html>
    ...
    <body>
        <div class="header1">
         <table style="margin: 0px;">
            <tr>
                ...
                <td><a href="" style="text-decoration: none; font-size: 24px; color: rgb(90, 0, 0);">BOOKZONE</a></td></tr>
        </table>
        </div>
        <div class="header2">
        ...
        <div class="left"></div>
        <div class="middle">
            <form action="admin_login_query.php">
                <div class="x">
                <table style="text-align:center;">
                    <tr><td><input type="text" placeholder="username" class="textbox" name="t1"><td></tr>
                    <tr><td><input type="text" placeholder="password" class="textbox" name="t2"><td></tr>
                    <tr><td><input type="submit"><td></tr>
                </table>
                <a href="admin_signup_page.php" style="text-decoration:none;">is you are not register</a>
                </div>
            </form>
        </div>
        <div class="right"></div>
